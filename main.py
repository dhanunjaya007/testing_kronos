...
async def chat(ctx, *, prompt: str):
    ...
    try:
        # All required parameters for /predict
        ...
        # result is a tuple of 4 elements ([0]=chatbot reply, [3]=raw text)
        # Usually, [3] is the plain answer
        # For best results and formatting, get the answer from result[3]:
        reply = result[3]
